...
TARname="numu_uBooNE_Flux_500k.tar"
FileListName="gntp_HEPevt_0_splited_file.list"   # name of the list of HEPevt files
TemplateFhicl="wrapper_batch_TEMPLATE.fcl"
FinalFhicl="wrapper_batch_LOCAL.fcl"
